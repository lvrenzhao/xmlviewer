package com.ahqy.xmlviewer.utils;
...
public class PdfReportM1HeaderFooter extends PdfPageEventHelper {
    ...
    private int noNumberPages = 0;

    public int getNoNumberPages() {
        return noNumberPages;
    }
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        try {
            ...
            if (fontDetail == null) {
                fontDetail = new Font(bf, presentFontSize);
            }
        ...
        if(pageS>noNumberPages){
            String foot1 = "第 " + (pageS - noNumberPages) + " 页 /共";
    ...
    public void onCloseDocument(PdfWriter writer, Document document) {
        ...
        String foot2 = " " + (writer.getPageNumber() -1 - noNumberPages) + " 页";
